      ...
      <Box mt={16} bg={color.white} p="16px 20px">
        ...
        <Box  mt="auto" pt="32px">
          ...
          >
            ...
            >
              <Box position="relative" width="36px" height="36px" borderRadius="99px" overflow="hidden">
                <Image alt='profile' src="/images/dummy/dummy_nft.jpeg" fill sizes="100% auto" objectFit="cover"/>
              </Box>
              <Text ml="12px" color={color.background.layer2} fontWeight={500} fontSize="21px" lineHeight="26px">
